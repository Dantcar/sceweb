...
public class UC05CadastrarConvenio {
	...
	@Test(expected=IllegalArgumentException.class)
	public void CT04UC05A1Cadastrar_convenio_data_formato_valido(){
		assertTrue(convenio.validaData("28/05/2016"));
	}
...
//		assertEquals (26, convenio.convenioJaCadastrado(df,di));
//	}
